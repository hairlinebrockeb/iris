...
return function(Iris: Types.Internal)
    ...
    get(script.Root)(Iris, widgets)
    get(script.Window)(Iris, widgets)

    get(script.Menu)(Iris, widgets)

    get(script.Format)(Iris, widgets)

    get(script.Text)(Iris, widgets)
    get(script.Button)(Iris, widgets)
    get(script.Checkbox)(Iris, widgets)
    get(script.RadioButton)(Iris, widgets)

    get(script.Tree)(Iris, widgets)

    get(script.Input)(Iris, widgets)
    get(script.Combo)(Iris, widgets)
    get(script.Plot)(Iris, widgets)

    get(script.Table)(Iris, widgets)
end
